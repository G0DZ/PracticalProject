		...
		private void InsSort()
		{
			...
			for (i = 1; i < parent.vpanel.PanelArray.length; i++)
	    	{
				...
				synchronized (this)
	    		{
		    		...
		    		parent.vpanel.repaint();
		    		parent.StrLog = parent.StrLog + "Шаг " + i + "\nТекущий элемент, лежащий в ячейке с индексом " + i + ", был помещен в ячейку\nмассива с индексом " + j + ";\n";
	    			parent.StrLog = parent.StrLog + "При этом произошел сдвиг всех элементов, больших текущего элемента\nи лежащих в ячейках с индексом, меньшим, чем индекс текущего\n элемента;\n";
		    		if (parent.L != null) 
